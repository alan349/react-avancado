...
const validationSchema = yup.object({
  ...
  cardNumber: yup.string()
    .min(13, "Mínimo 13 dígitos")
    .max(19, "Máximo 19 dígitos")
    .test("card-number", "Cartão de Crédito Inválido", (value) => {
      return detectCard(value)
    })
    .required("Obrigatório"),
  cardExpirationDate: yup.date()
    .min(new Date(), "Data de Válidade do Cartão inválida")
    .required("Obrigatório"),
  cardCVV: yup.string()
